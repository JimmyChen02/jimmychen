  ...
  return (
    <div className="relative">
      ...
      <main className="relative z-10">
        ...
        {/* Profile snapshot — deliberate break from the pipeline metaphor,
            placed here so a recruiter sees the full picture right after the
            opener without scrolling through all 8 stages first. */}
...
function StageSkeleton() {
  return (
    <div className="py-32 flex justify-center" aria-hidden="true">
      <div className="w-6 h-6 border-2 border-knicks-orange/20 border-t-knicks-orange/60 rounded-full animate-spin" />
    </div>
  );
}
