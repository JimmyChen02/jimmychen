  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <motion.div
            className="flex-1 w-px border-l border-dashed border-knicks-orange/50"
          />
          <motion.span
            className="font-mono text-xs text-knicks-orange leading-none py-0.5"
            style={{ fontSize: "14px" }}
  ...
  return (
    <motion.div
      ...
      className={[
        ...
        cutting
          ? "border border-knicks-orange/55 bg-knicks-orange/8 shadow-[0_0_14px_rgba(245,132,38,0.3)]"
          : "border border-transparent",
      ].join(" ")}
    >
      <motion.span
        className="font-mono text-xl sm:text-2xl font-medium"
        animate={{ color: cutting ? "#F58426" : "#ffffff" }}
      ...
      <AnimatePresence>
        {cutting && (
          <motion.span
            className="absolute -top-5 left-1/2 -translate-x-1/2 font-mono text-[9px] text-knicks-orange/55 whitespace-nowrap pointer-events-none"
...
function BpeChip({
  ...
  const borderCls =
    variant === "purple"
      ? "border-knicks-blue/40 bg-knicks-blue/8 text-knicks-blue"
  ...
  if (layoutId) {
    return (
      <motion.div layoutId={layoutId} className="flex flex-col items-center gap-1.5">
        ...
        <span className="font-mono text-[10px] text-white/50">{index}</span>
      </motion.div>
    );
  }
    ...
    >
      ...
      >
        ...
        <p className="text-white/50 font-mono text-sm">
          tokenizer(<span className="text-knicks-orange">&quot;{rawText}&quot;</span>)
        </p>
      </motion.div>
      ...
      <LayoutGroup>
        <motion.div layout className="w-full space-y-6 sm:space-y-7 lg:space-y-8">
          ...
          <div className="flex flex-col items-center gap-2.5">
            <p className="font-mono text-xs text-white/45 uppercase tracking-widest">Input</p>
            ...
            >
              ...
              <div className="absolute inset-0 rounded-xl overflow-hidden pointer-events-none">
                <AnimatePresence>
                  {phase === "scanning" && (
                    <motion.div
                      className="absolute inset-y-0 w-[2px] bg-knicks-orange rounded"
                      style={{ boxShadow: "0 0 14px 5px rgba(245,132,38,0.5)" }}
                      initial={{ left: "-2px" }}
                      animate={{ left: "100%" }}
                      exit={{ opacity: 0 }}
              ...
              <div className="flex items-center justify-center gap-0 flex-wrap pt-4">
                <span className="font-mono text-xl sm:text-2xl text-knicks-orange/65 mr-0.5 select-none">&quot;</span>
                ...
                <span className="font-mono text-xl sm:text-2xl text-knicks-orange/65 ml-0.5 select-none">&quot;</span>
              </div>
            ...
            {isTokens && (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-mono text-xs text-white/45 uppercase tracking-widest">BPE Tokens</p>
                  <span className="w-8 h-px bg-white/10" />
                </div>
          ...
          <AnimatePresence>
            {isTokens && (
              ...
              >
                <div className="flex items-center gap-2">
                  <span className="w-8 h-px bg-white/10" />
                  <p className="font-mono text-xs text-white/45 uppercase tracking-widest">Identity Tokens</p>
                  <span className="w-8 h-px bg-white/10" />
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {TOKENS.map((token, i) => (
                    <motion.div
                      ...
                      className="group flex items-center gap-2 px-3.5 py-2 rounded-md border border-white/10 bg-white/[0.03] hover:border-knicks-orange/30 hover:bg-knicks-orange/5 transition-colors cursor-default"
                    >
                      <span className="font-mono text-[10px] text-white/45 group-hover:text-knicks-orange/40 transition-colors w-4 text-right shrink-0">
                        {i}
                      </span>
